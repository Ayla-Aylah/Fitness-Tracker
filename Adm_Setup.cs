...
{
    public partial class frm_Adm_Setup : Form
    {
        public frm_Adm_Setup()
        {
            InitializeComponent();
            SystID();
        }

        FitTrack_DataSetTableAdapters.Adm_SetupTableAdapter objAdmAuthn = new FitTrack_DataSetTableAdapters.Adm_SetupTableAdapter();
        ...
        public void SystID()
        {
            ...
            dtSystID = objAdmAuthn.Get_AdmSet_Data();
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                objAdmAuthn.Insert_Adm_Query(objAdmC.AdmID, objAdmC.AdmUsName, objAdmC.AdmLglName, objAdmC.AdmPw, objAdmC.AdmEmail);
        ...
        private void Login_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            frmAdm_Login AdmLog= new frmAdm_Login();
            AdmLog.Show();
            this.Hide();
        }
        ...
        private void txtAdmEmail_TextChanged(object sender, EventArgs e)
        {
