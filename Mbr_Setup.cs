...
{
    public partial class Frm_Mbr_Setup : Form
    {
        public Frm_Mbr_Setup()
        {
            InitializeComponent();
            SystID();
        }

        FitTrack_DataSetTableAdapters.Mbr_SetupTableAdapter objMbrAuthn = new FitTrack_DataSetTableAdapters.Mbr_SetupTableAdapter();
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            //Controlling of Username Input 
              ...
              {
                  MessageBox.Show("Only 12 to 20 characters are allowed for password!", "Password Input Failed", MessageBoxButtons.RetryCancel);
                  txtMbrPw.Focus();
              }
             ...
             //controlling of Phone Number Input
              ...
              else
              {
                 ...
                 int height = Convert.ToInt32(txtMbrHeight.Text.ToString());
                  ...
                  objMbrAuthn.Insert_Mbr_Query(lblMbrID.Text, txtMbrUsName.Text, txtMbrLglName.Text, txtMbrPw.Text, txtMbrEmail.Text, txtMbrPh.Text, Gender, TodayDate.ToString(), txtMbrAddress.Text, weight, height, path);
        ...
        private void lblMbrID_Click(object sender, EventArgs e)
        {

        }

        private void txtMbrHeight_TextChanged(object sender, EventArgs e)
        {
